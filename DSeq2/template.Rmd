...
all_genes_df <- read_csv("CD8_vs_CD4_DE_results_lfcshrinkage_allgenes.csv") #if you used read.csv, it would use the base r version, and load into a standard 'data.frame', not a DataFrame. 

# check its dimensions - and look at the top of the file -> what does this tell us about our table? 
all_genes_df
dim(all_genes_df) #22 535 rows, 6 columns
